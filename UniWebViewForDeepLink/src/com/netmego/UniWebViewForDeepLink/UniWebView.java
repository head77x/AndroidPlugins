...
public class UniWebView extends VideoEnabledWebView {
    ...
    public static boolean acceptThirdPartyCookie;
    ...
    public UniWebView(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            CookieManager.getInstance().setAcceptThirdPartyCookies(this, acceptThirdPartyCookie);
    ...
    public void setAllowAutoPlay(boolean flag) {
        if (Build.VERSION.SDK_INT >= 17) {
            this.getSettings().setMediaPlaybackRequiresUserGesture(!flag);
        }
    }
