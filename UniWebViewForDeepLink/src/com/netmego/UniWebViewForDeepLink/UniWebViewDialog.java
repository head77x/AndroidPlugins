 ...
 */
package com.netmego.UniWebViewForDeepLink;
...
public class UniWebViewDialog extends Dialog {
    ...
    private ArrayList<String> certTrustedHosts;
    ...
    private boolean _currentLoadingNoError = true;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (_manualHide) {
            event.offsetLocation(_left, _top);
    ...
    @SuppressLint("NewApi")
    public UniWebViewDialog(Activity context, DialogListener listener) {
        ...
        certTrustedHosts = new ArrayList<String>();
            ...
            h.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if (show) {
                        ...
                        UniWebViewDialog.this._content.setVisibility(View.GONE);
    ...
    private void createWebView() {
        ...
        WebViewClient webClient = new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                UniWebViewDialog.this._currentLoadingNoError = true;
                UniWebViewDialog.this._userStopped = false;
            ...
            public void onPageFinished(WebView view, String url) {
                if (UniWebViewDialog.this._userStopped) {
                    onReceivedError(view, 999, "Loading process is cancelled.", url);
                }
                ...
                if (UniWebViewDialog.this._currentLoadingNoError) {
            ...
            public void onReceivedError (WebView view, int errorCode, String description, String failingUrl) {
                UniWebViewDialog.this._currentLoadingNoError = false;
            ...
            public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
                ...
                Log.d(AndroidPlugin.LOG_TAG, "Received an ssl error from url: " + url + ". Trying to recover for host: " + host);
                for (String value: certTrustedHosts) {
    ...
    public  void addCertTrustedHose(String host) {
        if (host != null && host.length() != 0) {
            certTrustedHosts.add(host);
        }
    }
